...
namespace TerrainEngine2D
{
    ...
    /// </summary>
    public class WorldMultiplayer : NetworkBehaviour
    {
        ...
        private static WorldMultiplayer instance;
        public static WorldMultiplayer Instance
        {
            get { return instance; }
            set { instance = value; }
        }
        ...
        void Start()
        {
            ...
            {
                if (basicLighting)
                    lightSystem.InitializeMultiplayer(this);
                else
                {
