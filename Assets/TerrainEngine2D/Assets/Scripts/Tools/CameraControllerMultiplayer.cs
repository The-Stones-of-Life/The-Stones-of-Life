...
namespace TerrainEngine2D
{
    ...
    /// </summary>
    public class CameraControllerMultiplayer : MonoBehaviourSingleton<CameraControllerMultiplayer>
    {
        ...
        private void Start()
        {
            if (GameObject.Find("NetworkManager") != null)
            {
                ...
                if (pixelPerfectCamera)
                {
                    ...
                    mainCamera.orthographicSize = (Screen.height / (worldMultiplayer.PixelsPerBlock * cameraSizeScale)) * 0.5f;
                ...
                transform.position = new Vector3(transform.position.x, transform.position.y, worldMultiplayer.EndZPoint - worldMultiplayer.ZBlockDistance * worldMultiplayer.ZLayerFactor * World.CAMERA_Z_ORDER);
            ...
            if (GameObject.Find("NetworkManager") != null)
            {
                ...
                switch (followType)
                {
                    case Followtype.Permanent:
                        ...
                        maxX = worldMultiplayer.WorldWidth - camHalfWidth;
                        minY = mainCamera.orthographicSize;
                        maxY = worldMultiplayer.WorldHeight - mainCamera.orthographicSize;
