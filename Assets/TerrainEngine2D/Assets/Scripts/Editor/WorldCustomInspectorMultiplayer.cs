...
namespace TerrainEngine2D.Editor
{
    ...
    /// </summary>
	[CustomEditor (typeof(WorldMultiplayer))]
    [CanEditMultipleObjects]
	public class WorldCustomInspectorMultiplayer : UnityEditor.Editor
	{
        ...
        private void OnEnable ()
		{
            ...
            worldInputHandler = FindObjectOfType<WorldInputHandlerMultiplayer>();
        ...
        void GenerateWorld()
        {
            ...
            world.TerrainGenerator.InitializeMultiplayer(world, worldData, fluidDynamics, advancedFluidDynamics);
