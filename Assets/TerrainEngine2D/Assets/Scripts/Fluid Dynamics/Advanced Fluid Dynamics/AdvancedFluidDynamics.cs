...
namespace TerrainEngine2D
{
    ...
    public class AdvancedFluidDynamics : MonoBehaviourSingleton<AdvancedFluidDynamics>
    {
        ...
        void TopDownFlow(int x, int y, AdvancedFluidBlock fluidBlock)
        {
            ...
            if (fluidBlock.BottomBlock != null && fluidBlock.BottomBlock.Weight != AdvancedFluidBlock.SolidWeight && (fluidBlock.BottomBlock.Density == fluidBlock.Density || fluidBlock.BottomBlock.Weight == 0))
            {
                ...
                if (flowAmount > 0)
                {
                    ...
                    if (fluidBlock.BottomBlock.Weight == 0)
                    {
            ...
            if (fluidBlock.RightBlock != null && fluidBlock.RightBlock.Weight != AdvancedFluidBlock.SolidWeight && (fluidBlock.RightBlock.Density == fluidBlock.Density || fluidBlock.RightBlock.Weight == 0)) 
            {
                ...
                if (flowAmount > 0)
                {
                    ...
                    if (fluidBlock.RightBlock.Weight == 0)
                    {
            ...
            //Flow left
            if (fluidBlock.LeftBlock != null && fluidBlock.LeftBlock.Weight != AdvancedFluidBlock.SolidWeight && (fluidBlock.LeftBlock.Density == fluidBlock.Density || fluidBlock.LeftBlock.Weight == 0)) 
            {
                ...
                if (flowAmount > 0)
                {
                    ...
                    if (fluidBlock.LeftBlock.Weight == 0)
                    {
            ...
            //Flow up
            if (fluidBlock.TopBlock != null && fluidBlock.TopBlock.Weight != AdvancedFluidBlock.SolidWeight && (fluidBlock.TopBlock.Density == fluidBlock.Density || fluidBlock.TopBlock.Weight == 0))
            {
                ...
                if (flowAmount > 0)
                {
                    ...
                    if (fluidBlock.TopBlock.Weight == 0)
                    {
        ...
        void DownFlow(int x, int y, AdvancedFluidBlock fluidBlock)
        {
            ...
            if (fluidBlock.BottomBlock != null && fluidBlock.BottomBlock.Weight != AdvancedFluidBlock.SolidWeight && (fluidBlock.BottomBlock.Density == fluidBlock.Density || fluidBlock.BottomBlock.Weight == 0 || (allowSurfaceFilling && fluidBlock.BottomBlock.Weight < maxWeight)))
            {
                //------Calculate the amount of fluid to flow down-----
            ...
            if (fluidBlock.RightBlock != null && fluidBlock.RightBlock.Weight != AdvancedFluidBlock.SolidWeight && (fluidBlock.RightBlock.Density == fluidBlock.Density || fluidBlock.RightBlock.Weight == 0)) //|| (SurfaceFilling && fluidBlock.RightBlock.Weight < maxWeight)
            {
                //Calculate the amount of fluid to flow horizontally between the blocks
                //Move one quarter of the difference between the two blocks to the block with less fluid
                flowAmount = (remainingAmount - fluidBlock.RightBlock.Weight) / 4f;
            ...
            //Flow left
            if (fluidBlock.LeftBlock != null && fluidBlock.LeftBlock.Weight != AdvancedFluidBlock.SolidWeight && (fluidBlock.LeftBlock.Density == fluidBlock.Density || fluidBlock.LeftBlock.Weight == 0)) //|| (SurfaceFilling && fluidBlock.LeftBlock.Weight < maxWeight)
            {
                flowAmount = (remainingAmount - fluidBlock.LeftBlock.Weight) / 4f;
                if (flowAmount < 0)
                    flowAmount = 0;
            ...
            //Flow up
            if (fluidBlock.TopBlock != null && fluidBlock.TopBlock.Weight != AdvancedFluidBlock.SolidWeight && (fluidBlock.TopBlock.Density == fluidBlock.Density || fluidBlock.TopBlock.Weight == 0)) //|| (SurfaceFilling && fluidBlock.TopBlock.Weight < maxWeight)
            {
                //Get the total amount of fluid
